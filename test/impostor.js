...
// current directory 
const roleWasm = "../circom/zk/impostor_js/impostor.wasm";
const finalKey = "../circom/zk/zkey/impostor_final.zkey";
const verificationKeyPath = "../circom/zk/impostor_verification_key.json";

async function run() {
    // Generate random values for secret and nonce
    const secret = 1;   // 0 is secret value for impostor
