#!/bin/sh
set -e
wersoftau new bn128 15 zk/ptau/pot15_0000.ptau -v
...
yarn snarkjs powersoftau contribute zk/ptau/pot15_0000.ptau zk/ptau/pot15_0001.ptau \
    --name="First contribution Sarthak" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/ptau/pot15_0001.ptau zk/ptau/pot15_0002.ptau \
    --name="Second contribution Siddhant" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/ptau/pot15_0002.ptau zk/ptau/pot15_0003.ptau \
    --name="Third contribution Shubham" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
